...
rule biscuit_align:
    ...
    shell:
        ...
        samblaster -M -a --excludeDups --addMateTags -d {params.disc} -s {params.split} -u {params.unmapped} 2> {log.samblaster} | \
...
rule biscuit_qc:
    ...
    params:
        ...
        sample="{sample}",
    output:
        "analysis/BISCUITqc/{sample}_all_cv_table.txt",
        "analysis/BISCUITqc/{sample}_covdist_cpg_q40_botgc_table.txt",
        "analysis/BISCUITqc/{sample}_covdist_cpg_q40_table.txt",
        "analysis/BISCUITqc/{sample}_covdist_cpg_q40_topgc_table.txt",
        "analysis/BISCUITqc/{sample}_covdist_cpg_table.txt",
        "analysis/BISCUITqc/{sample}_covdist_q40_botgc_table.txt",
        "analysis/BISCUITqc/{sample}_covdist_q40_table.txt",
        "analysis/BISCUITqc/{sample}_covdist_q40_topgc_table.txt",
        "analysis/BISCUITqc/{sample}_covdist_table.txt",
        "analysis/BISCUITqc/{sample}_cpg_cv_table.txt",
        "analysis/BISCUITqc/{sample}_cpg_dist_table.txt",
        "analysis/BISCUITqc/{sample}_CpGRetentionByReadPos.txt",
        "analysis/BISCUITqc/{sample}_CpGRetentionDist.txt",
        "analysis/BISCUITqc/{sample}_CpHRetentionByReadPos.txt",
        "analysis/BISCUITqc/{sample}_dup_report.txt",
        "analysis/BISCUITqc/{sample}_freqOfTotalRetentionPerRead.txt",
        "analysis/BISCUITqc/{sample}_isize_score_table.txt",
